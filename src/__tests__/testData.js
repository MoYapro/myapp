export const staticUserData = {
  stashes: [{
    ...
    },
    {
      ...
      items: [
        {id: 1, monthYear: {year: 2018, month: 0, day: 10}, value: -12, repeated: false, note: 'Kino'},
        {id: 2, monthYear: {year: 2018, month: 0, day: 1}, value: 1200, repeated: false, note: 'Gehalt Tom'},
        {id: 3, monthYear: {year: 2018, month: 0, day: 2}, value: 600, repeated: false, note: 'Gehalt Anne'},
        {id: 4, monthYear: {year: 2018, month: 0, day: 19}, value: 200, repeated: false, note: 'Kindergeld'},
        {id: 5, monthYear: {year: 2018, month: 0, day: 4}, value: -600, repeated: false, note: 'Miete'},
        {id: 6, monthYear: {year: 2018, month: 0, day: 6}, value: -300, repeated: false, note: 'Strom/Gas'},
        {id: 7, monthYear: {year: 2018, month: 0, day: 1}, value: -320, repeated: false, note: 'Wocheneinkauf'},
        {id: 8, monthYear: {year: 2018, month: 0, day: 2}, value: -32, repeated: false, note: 'Handy'},
        {id: 9, monthYear: {year: 2018, month: 0, day: 20}, value: -50, repeated: false, note: 'Kino'},
        {id: 10, monthYear: {year: 2018, month: 0, day: 23}, value: -88, repeated: false, note: 'Urlaub'},
        {id: 11, monthYear: {year: 2018, month: 0, day: 21}, value: -200, repeated: false, note: 'Tierarzt'},
        {id: 12, monthYear: {year: 2018, month: 1, day: 16}, value: -33, repeated: false, note: 'Urlaub'},
